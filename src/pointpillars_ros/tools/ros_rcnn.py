...
class Pointpillars_ROS:
    ...
    def init_ros(self):
        ...
        config_path = rospy.get_param("/config_path", "/home/pointpillars_ros/src/pointpillars_ros/tools/cfgs/kitti_models/pointrcnn.yaml")
        ckpt_path = rospy.get_param("/ckpt_path", "/home/pointpillars_ros/src/pointpillars_ros/tools/OpenPCDetZoo/pointrcnn_7870.pth")
